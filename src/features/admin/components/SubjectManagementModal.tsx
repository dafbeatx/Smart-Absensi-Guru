...
export const DEFAULT_SUBJECTS: SubjectItem[] = [
  { id: 'sub_1', name: 'PAI – Pendidikan Agama Islam', category: 'Keagamaan', code: 'PAI' },
  { id: 'sub_2', name: 'IPA – Ilmu Pengetahuan Alam', category: 'Umum / Wajib', code: 'IPA' },
  { id: 'sub_3', name: 'MTK – Matematika', category: 'Umum / Wajib', code: 'MTK' },
  { id: 'sub_4', name: 'PP – Pendidikan Pancasila', category: 'Umum / Wajib', code: 'PP' },
  { id: 'sub_5', name: 'B. Indonesia – Bahasa Indonesia', category: 'Umum / Wajib', code: 'B. Indonesia' },
  { id: 'sub_6', name: 'IPS – Ilmu Pengetahuan Sosial', category: 'Umum / Wajib', code: 'IPS' },
  { id: 'sub_7', name: 'B. Arab – Bahasa Arab', category: 'Muatan Lokal', code: 'B. Arab' },
  { id: 'sub_8', name: 'B. Inggris – Bahasa Inggris', category: 'Umum / Wajib', code: 'B. Inggris' },
  { id: 'sub_9', name: 'SBPK – Seni Budaya dan Prakarya', category: 'Umum / Wajib', code: 'SBPK' },
  { id: 'sub_10', name: 'Informatika', category: 'Umum / Wajib', code: 'Informatika' },
  { id: 'sub_11', name: 'Hadits', category: 'Keagamaan', code: 'Hadits' },
  { id: 'sub_12', name: "BTQ – Baca Tulis Al-Qur'an", category: 'Keagamaan', code: 'BTQ' },
  { id: 'sub_13', name: 'Pendidikan Jasmani, Olahraga, & Kesehatan', category: 'Umum / Wajib', code: 'PJOK' },
  { id: 'sub_14', name: 'Bimbingan Konseling (BK)', category: 'Umum / Wajib', code: 'BK' },
  { id: 'sub_15', name: 'Bahasa Daerah / Sunda', category: 'Muatan Lokal', code: 'BSUN' },
];
