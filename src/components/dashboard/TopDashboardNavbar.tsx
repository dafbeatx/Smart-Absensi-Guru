        ...
        <div className="flex items-center gap-3 flex-1 max-w-xl">
          ...
          <div className="relative flex-1 hidden sm:block">
            ...
            <input
              ...
              className="w-full pl-9 pr-14 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-[#287094] transition-all"
            />
