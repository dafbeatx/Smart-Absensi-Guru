...
import { Search, X, User, LayoutDashboard, Eye, Users, Calendar, Settings, QrCode, Edit3, TestTube, ArrowRight, MessageSquare, GraduationCap, BarChart3 } from 'lucide-react';
...
export const AdminCommandPaletteModal: React.FC<AdminCommandPaletteModalProps> = ({
  ...
  const commandItems = useMemo<CommandItem[]>(() => {
    ...
    const pages = [
      ...
      { id: 'TRAFFIC', title: 'Trafik Fitur Web Guru', subtitle: 'Lacak fitur dan menu web yang sering dibuka guru', icon: <BarChart3 className="w-4 h-4 text-[#287094]" /> },
      ...
      >
        ...
        <div className="p-3.5 sm:p-4 border-b border-slate-100 flex items-center gap-3 bg-slate-50/70">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-xs sm:text-sm font-bold text-slate-800 focus:outline-none"
          />
          {searchQuery && (
            <button
